...
export const TareaSchema = z.object({
  ...
  situacion:          z.enum(['atrasada', 'reprogramada', 'creada']).nullable().optional(),
  reprogramaciones:   z.number().int().nonnegative().optional(),
  ...
  workspace_id:       idNul.optional(),
  cliente_id:         idNul.optional(),
  proyecto_id:        idNul.optional(),
  area_id:            idNul.optional(),
