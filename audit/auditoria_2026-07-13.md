...
Resultado acumulado: `hooks/` 9.46% → 18.45% statements; global 31.54% → 36.73%. Sigue habiendo ~17 archivos de `hooks/` en 0% (los hooks `useXxxPage`, los más grandes y costosos) — este hallazgo permanece abierto como backlog, no se marca resuelto.
