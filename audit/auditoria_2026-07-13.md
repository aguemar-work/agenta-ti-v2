...
Resultado acumulado: `hooks/` 18.45% → 34.1% statements; global 36.73% → 45.3%. Sigue habiendo ~9 archivos de `hooks/` en 0% (los hooks `useXxxPage` restantes) — este hallazgo permanece abierto como backlog, no se marca resuelto.
